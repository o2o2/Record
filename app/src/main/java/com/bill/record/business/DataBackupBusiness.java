...
import com.bill.record.database.base.SQLiteDataBaseConfig;
import com.bill.record.uitls.FileUtil;
...
/**
 * Created by Wookeibun on 2017/8/8.
 */
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(
                ...
                if (sourceFile.exists()) {
                    ...
                    FileUtil.cp(DATA_PATH + SQLiteDataBaseConfig.DATABASE_NAME,
    ...
    public boolean databaseRestore() {
        ...
        try {
            ...
            if (databaseBackupDate != 0) {
                ...
                FileUtil.cp(
                        SDCARD_PATH + SQLiteDataBaseConfig.DATABASE_NAME,
                        DATA_PATH + SQLiteDataBaseConfig.DATABASE_NAME);
            }
            result = true;
        } catch (Exception e) {
            e.printStackTrace();
